...
const GLOSSARY: Array<{ section: string; items: Array<{ term: string; desc: string }> }> = [
  {
    ...
    items: [
      ...
      { term: "Torneos / Desafíos activos", desc: "Torneos en curso y desafíos de Staderilla aún no resueltos." },
  ...
  },
  {
    ...
    items: [
      ...
      { term: "Staderillas activas", desc: "Ladders ordenadas por partidos jugados." },
    ],
  },
  {
    section: "Alertas",
