...
export const THEMES: Record<ThemeId, ThemeMeta> = {
  ...
  "etat-francais": {
    id: "etat-francais",
    label: "Stade Français",
    sublabel: "Bleu Stade · bleu / blanc / rouge",
    swatches: ["#003DDC", "#E1000F", "#FFD400", "#FFFFFF"],
    fontDisplay: "Marcellus, Georgia, serif",
    fontSans: "Inter, system-ui, sans-serif",
  },
};

export const THEME_IDS: ThemeId[] = ["etat-francais", "terre-battue"];
export const THEME_MODES: ThemeMode[] = ["light", "dark", "system"];

export const DEFAULT_THEME: ThemeId = "etat-francais";
